...
//   const [phone, setPhone] = useState<string>("");
//   const [genCode, setGenCode] = useState<string>("");
//   const [step, setStep] = useState<"phone" | "genCode">("phone");
//   async function onRegisterPress() {
//     const registered = await register(phone);
//     if (registered) {
//       setStep("genCode");
...
//   }
//   async function onLoginPress() {
//     const loggedin = await login(phone, genCode);
//     if (loggedin) {
...
//         <View style={styles.inputContainer}>
//           <View style={{ flex: 1 }}>
//             <Headline>{"شماره موبایل خود را وارد کنید."}</Headline>
//           </View>
